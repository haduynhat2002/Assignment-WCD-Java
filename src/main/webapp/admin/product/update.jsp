...
<%@ page import="com.example.javahaduynhat.entity.myenum.ProductStatus" %>
                            ...
                            <form action="${pageContext.request.contextPath}/admin/product/update" method="post">
                                <div class="m-3 mt-3">
                                    ...
                                    <select name="categoryId" id="inputState" class="form-control">
                                        ...
                                        <option <%=category.get(i).getId() == product.getCategoryId() ? "selected" : ""%>
                                                value="<%=category.get(i).getId()%>"><%=category.get(i).getName()%>
                                        </option>
                                        <% } %>
                                    </select>
