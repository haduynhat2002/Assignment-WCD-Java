...
import com.example.javahaduynhat.constant.SqlConstant;
...
import com.example.javahaduynhat.service.ConnectionHelper;
...
public class MySqlProductModel implements ProductModel {
    ...
    public boolean save(Product product) {
        try {
            ...
            preparedStatement.setString(6, product.getSaleDate().toString());
    ...
    public boolean update(int id, Product updateObj) {
        ...
        try {
            ...
            preparedStatement.setString(6, updateObj.getDateFix().toString());
    ...
    public List<Product> findAll() {
        ...
        try {
            ...
            preparedStatement.setInt(1, ProductStatus.ARESELLING.getValue());
    ...
    private Product convertResultSetToProduct(ResultSet resultSet) {
        try {
            ...
            LocalDateTime saleDate = resultSet.getTimestamp(SqlConstant.PRODUCT_FIELD_SALE_DATE).toLocalDateTime();
            ...
            Product Product = new Product(id, name, categoryId, description, thumbnail, price, saleDate, ProductStatus.of(status));
